...
struct WelcomeView: View {
    ...
    var body: some View {
        VStack {
            ...
            Text("I'm a privacy first application that lives here in the menu bar on your Mac, providing you a quick way to glance at your Continous Glucose Monitor (CGM) readings, from places like Nightscout and Dexcom").multilineTextAlignment(.center)
