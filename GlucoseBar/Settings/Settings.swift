...
class SettingsStore: ObservableObject, @unchecked Sendable {
    ...
    @Published var aidChartShowCOBChart: Bool = true
    ...
    private func loadInternal() {
        ...
        self.aidChartShowCOBChart = defaults.bool(forKey: key("aidChartShowCOBChart"))
    ...
    private func saveInternal() {
        ...
        defaults.set(self.aidChartShowCOBChart, forKey: key("aidChartShowCOBChart"))
