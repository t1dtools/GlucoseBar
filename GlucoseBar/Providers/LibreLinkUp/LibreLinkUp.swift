...
//
//                    // COMPLETED AUTH
//                    self.auth = ProviderAuth(token: result.data!.authTicket?.token!, expiry: result.data!.authTicket!.expires)
//
//                    // Getting connections
//                    Task {
...
//
//        if auth!.token != "" {
//            let expiryTime = Date(timeIntervalSince1970: Double(auth!.expiry))
//
